...
import escalade from 'https://esm.sh/gh/rivy-fix/escalade@19b6c73c3e/deno/sync.ts'; // 3.1.1-deno-rivy
import Parser from 'https://esm.sh/gh/rivy-fix/yargs-parser@78e3cb983e/deno.ts'; // 21.1.1-deno-rivy
import y18n from 'https://esm.sh/gh/rivy-fix/y18n@b3e551ddac/deno.ts'; // v5.0.8-deno-rivy
